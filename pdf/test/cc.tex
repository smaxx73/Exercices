...
\title{Analyse de l'Usure des Véhicules Blindés en Mission}
\author{Étude Statistique et Régression}
\date{}
...
\begin{itemize}
    \item \( X \) : \textbf{Nombre de jours en mission dans une zone de conflit} (\textit{variable quantitative discrète}).
    \item \( Y \) : \textbf{Coût moyen des réparations après mission} (en milliers d’euros) (\textit{variable quantitative continue}).
\end{itemize}

Les ingénieurs militaires suspectent que la relation \textbf{n’est pas linéaire}, car l’usure des véhicules suit une \textbf{loi exponentielle} due à la détérioration progressive des composants mécaniques.
...
\section{Analyse exploratoire des variables}
...
\section{Transformation des données et régression}
...
\begin{enumerate}
    ...
    \item \textbf{Analyser l’impact d’une maintenance intermédiaire} :
    \begin{itemize}
        \item Supposons qu’une maintenance soit effectuée \textbf{au jour 10}. Après cette date, l’usure suit une nouvelle loi exponentielle plus lente.
        \item Comparer le coût des réparations avec et sans maintenance intermédiaire.
    \end{itemize}
\end{enumerate}
...
\begin{itemize}
    \item Interpréter les résultats obtenus en termes d’optimisation de la maintenance des véhicules blindés.
    \item Proposer des recommandations pour minimiser les coûts de réparation tout en maintenant l’efficacité opérationnelle.
\end{itemize}

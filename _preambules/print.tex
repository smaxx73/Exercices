...
\newtcolorbox{titrebox}[3][]{
	...
	overlay unbroken and first={
		\node[anchor=north west, inner xsep=-2pt, inner ysep=-7pt] at (frame.north west) {\tikz{\node[draw, fill=titrecolor, inner sep=5pt] {\small\sffamily{\textcolor{white}{Ex #1}}};}};
	...
	top=30pt,
	bottom=10pt,
	borderline west={1pt}{0pt}{white!75!black},
	overlay unbroken and first={
		\ifthenelse{\boolean{uuid}}{
			\node[anchor=south east, inner sep=0pt] at (frame.south east) {\tikz{\node[draw, fill=black!85!white, inner sep=1pt] {
				\ifthenelse{\boolean{link}}{\href{\pathcorrige#3.pdf}{\textcolor{white}{\tiny\texttt{\##3}}}}{\textcolor{white}{\tiny\texttt{\##3}}}
				};}};
		}{}
		\node[anchor=north west, inner xsep=-2pt, inner ysep=2pt] at (frame.north west) {\tikz{\node[draw, fill=titrecolor, inner sep=5pt, rounded corners] {\sffamily\textbf{\textcolor{white}{Ex #1}}};}};
		\node[anchor=north east, inner sep=2pt] at (frame.north east) {\tikz{\node[] {\begin{marker}{#2}\end{marker}};}};
	}
}

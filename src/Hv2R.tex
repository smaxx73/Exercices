...
\item
  ...
  \reponse{
    Chaque facteur vaut $|w_h \cdot (1 - h_t^2)| = 0.8 \times (1 - 0.81) = 0.8 \times 0.19 = 0.152$.

    \[
      T = 5  : \quad 0.152^5 \approx 8.0 \times 10^{-4}
    \]
    \[
      T = 10 : \quad 0.152^{10} \approx 6.4 \times 10^{-8}
    \]
    \[
      T = 20 : \quad 0.152^{20} \approx 4.1 \times 10^{-15}
    \]
    Le gradient est pratiquement nul dès $T = 10$ : toute information sur $h_0$ est perdue lors de la rétropropagation, rendant l'apprentissage de dépendances longues impossible.
  }

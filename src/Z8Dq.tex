...
\indication{Écrire $\E(X^n)=\int_0^{+\infty}x^n\lambda e^{-\lambda x}\,\mathrm dx$. Une intégration par parties établit une récurrence entre les moments d'ordres $n$ et $n-1$.}

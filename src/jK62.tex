...
\begin{enumerate}
	...
	\indication{L'événement conjoint signifie qu'aucun des quatre tirages ne donne ni $1$ ni $2$. Comparer ensuite cette probabilité au produit des deux probabilités marginales.}
	\reponse{
		\begin{align*}
	...
	\indication{Commencer par la case $(0,0)$, puis obtenir les cases $(1,0)$ et $(0,1)$ par différence avec les marginales ; la dernière case se déduit car la somme des quatre cases vaut $1$.}
	\reponse{
		\begin{center}
	...
	\indication{Chaque indicatrice $X_i$ compte si la valeur $i$ a été vue. Écrire $X$ comme leur somme et utiliser la linéarité de l'espérance, sans supposer les $X_i$ indépendantes.}

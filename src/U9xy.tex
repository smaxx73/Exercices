...
\texte{ Soit $D = \{(x,y) \in \R^2 \, , \, y \geq 0 \, , \, x-y > 0\}$ un domaine de $\R^2$. }
\begin{enumerate}
	\item \question{Donner une représentation graphique de $D$. }
	\reponse{ 
	...
	\item \question{ Vérifier que le point $(2,2)$ n'appartient pas à $D$ mais qu'en revanche, il existe une suite de points $(x_n,y_n) \in D$ tels que $(x_n,y_n) \xrightarrow[n \to +\infty]{} (2,2)$. }

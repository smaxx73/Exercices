...
\texte{ Une machine est composée de trois alernateurs indépendants. la durée de vie de $T$ de chaque aléternateur suit une loi exponentielle de paramètre $\lambda$. La machine fonctionne si et seulement si au moins deux des alternateurs fonctionnent.  On appelle $X$ la variable aléatoire mesurant le temps de fonctionnement de la machine. }

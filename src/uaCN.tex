...
\contenu{
    ...
    \begin{enumerate}
        ...
        \item \texte{ Une dame fréquente cette ligne de bus chaque jours pendant 10 jours. On suppose que les retards journaliers sont indépendants. et on note $Y$ le nombre de jours où la dame a attendu moins de $7$ minutes. }
        \begin{enumerate}

...
\texte{	
Après enquête, on estime que le temps de passage à une caisse, exprimé en unités de temps, est une variable aléatoire $T$ dont une densité de probabilité est donnée par la fonction $f_T$ définie par:

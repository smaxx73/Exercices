...
\contenu{
    ...
    \indication{Noter $X$ le nombre de contrôles : $X$ suit une loi binomiale. Traduire la perte financière par $X\alpha>100$, puis approcher $X$ par une loi normale et utiliser le quantile inférieur d'ordre $0{,}05$.}

...
\contenu{
	...
	\begin{enumerate}
		...
		\indication{Scinder l'événement $G_{n+1}$ selon $G_n$ ou $\overline{G_n}$, puis appliquer la formule des probabilités totales. Faire de même pour le complément afin d'obtenir la seconde ligne de la matrice.}
		...
		\indication{Utiliser d'abord $v_n=1-u_n$ pour obtenir une récurrence affine $u_{n+1}=0{,}3u_n+0{,}3$. Chercher ensuite son point fixe avant de soustraire cette valeur à $u_n$.}
		\reponse{ 

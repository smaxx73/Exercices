...
\contenu{
    ...
    \begin{enumerate}
        ...
        \indication{Réutiliser l'événement de la question précédente, puis centrer-réduire $X$. Identifier le quantile normal correspondant à une probabilité centrale de $0{,}9544$ avant de résoudre l'inégalité en $n$.}
        \reponse{

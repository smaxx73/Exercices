...
\begin{enumerate}
    ...
    \indication{Traduire l'intersection dans le numérateur par $\{0<X\leq1/2\}$, puis calculer numérateur et dénominateur à l'aide de la fonction de répartition précédente.}
    \reponse{
...
Donc $\prob(X \leq \frac{1}{2} \mid X > 0) = \frac{\frac{1}{16}}{\frac{1}{2}} = \frac{1}{8}$. }
    ...
    \indication{Étudier $\{X^2\leq t\}$ par cas : vide si $t<0$, puis $\{-\sqrt t\leq X\leq\sqrt t\}$ ; le support de $X$ impose aussi un changement de cas à $t=1$.}
    \reponse{

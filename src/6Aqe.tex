...
\difficulte{}
\contenu{
    \texte{On considère le plan $\R^2$ muni d'un repère orthonormé $(O,\overrightarrow{OI},\overrightarrow{OJ})$. Soit $T$ l'intérieur du triangle $OIJ$ et soit $(X,Y)$ un couple de variables aléatoires suivant une loi uniforme sur le triangle $T$.
	\begin{enumerate}

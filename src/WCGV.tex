...
\begin{enumerate}
	...
	\item \question{ On prélève les circuits imprimés un par un et on les teste immédiatement. Quelle est la probabilité que le premier circuit imprimé défectueux apparaisse au $100$e tirage ? }
	...
	\indication{Les prélèvements se font sans remise dans une population finie : reconnaître une loi hypergéométrique et compter les choix de $5$ défectueux et de $495$ non défectueux.}

...
\texte{ Soit $f \colon \mathbb{R}^2 \to \mathbb{R}$ une fonction différentiable.  } 
	...
	\begin{enumerate}
		\item \question{ On fixe $(x,y) \in \mathbb{R}^2$ et pour tout $t \in \mathbb{R}$ on pose $g(t) = f(x+t,y+t)$. Calculer $g'(t)$ quelque soit $t \in \mathbb{R}$ en l'exprimant en fonction de $\dfrac{\partial f}{\partial x}(x,y)$ et $\dfrac{\partial f}{\partial y}(x,y)$. }

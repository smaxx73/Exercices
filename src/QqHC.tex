...
\begin{enumerate}
 ...
 \indication{Calculer séparément $\prob(X=1,Y=1)$, $\prob(X=1)$ et $\prob(Y=1)$ ; l'indépendance équivaut à l'égalité du premier terme avec le produit des deux autres.}
 \reponse{ On a:
 \begin{itemize}
 ...
 \indication{Il suffit de trouver une paire de valeurs pour laquelle la probabilité conjointe ne vaut pas le produit des marginales. Distinguer le cas $n=2$, seul cas non traité par la question précédente.}
 \reponse{ 
...
donc $X$ et $Y$ ont même loi.
  ...
  \indication{Pour chaque couple $(i,j)\in\{1,2,3\}^2$, décrire l'ordre des boules imposé par $X=i$ et $Y=j$, puis compter les tirages équiprobables compatibles.}
  \reponse{
    \begin{center}

...
\texte{ On donne ou on rappelle la définition de quelques lois usuelles :}
	...
	\begin{enumerate}
		...
		\item \question{A partir de la fonction \texttt{rand()} qui permet de simuler une loi uniforme sur $[0;1]$ et en utilisant les résultats des questions précédentes, écrire un programme qui permet de simuler une loi de Laplace 
	\end{enumerate}}
}

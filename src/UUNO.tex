...
\module{Analyse de données} 	%Analyse, Algèbre...
\chapitre{Réseaux de neurones}   			%Continuité, Groupes, Fonctions de plusieurs variables...
\sousChapitre{Architecture et propagation avant}			%Optimisation, Diagonalisation d'une matrice, Calcul de dérivées partielles...

\uuid{jj3V}
\titre{ Estimation d'une moyenne }
\theme{estimateurs, intervalles de confiance}
...
\begin{enumerate}
	...
	\reponse{ On en déduit, au seuil 90\%, un intervalle de confiance pour la 	moyenne par lecture de table de la loi normale centrée réduite avec $u_{\alpha/2 } \approx 1{,}644854$ : 

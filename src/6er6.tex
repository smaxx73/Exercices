...
\indication{Définir la variable aléatoire $X$ égale au nombre de produits demandés au cours d'une saison. Justifier que l'on cherche  $\alpha$ le niveau de stock en début de saison tel que $\prob(X\leq \alpha)=\nombre{0.9}$. }

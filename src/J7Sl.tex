...
\texte{
 ...
 \begin{enumerate}
    ...
    \item \question{ Soit la variable aléatoire $Y = X^2$. En distinguant éventuellement selon les valeurs de $t \in \R$, déterminer $a(t)$ et $b(t)$ de telle sorte que $\prob(Y \leq t) = \prob\left(a(t) \leq X \leq b(t)\right)$. }

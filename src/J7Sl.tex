...
\texte{
 ...
 \begin{enumerate}
    ...
    \indication{Résoudre l'inégalité $X^2\leq t$. Tenir compte du fait que $X$ est presque sûrement dans $[0,1]$, ce qui simplifie l'intervalle obtenu.}
    \reponse{
    ...
    \indication{Utiliser la question précédente pour écrire $F_Y(t)$ en fonction de $F_X$, en distinguant notamment $t<0$, $0\leq t\leq1$ et $t>1$, puis dériver sur l'intérieur du support.}
    \reponse{

...
\texte{ On considère le réseau de neurones à deux couches suivant :
\begin{center}
...
\begin{enumerate}
	...
	\item \question{ Exprime $\frac{\partial F}{\partial a}$ en fonction de $\frac{\partial F}{\partial \omega_5}$ et $\frac{\partial F}{\partial \omega_6}$. }
  ...
  \item \question{ En utilisant la méthode du gradient à pas constant $\delta = 0.1$, réaliser un apprentissage de ce réseau en déterminant les nouveaux poids $W_{nouveaux}$. }
\end{enumerate}
}
...
où $g_1$ et $g_2$ sont la fonction ReLu. 
	...
	\begin{center}\pythoncode{5NS7-relu.py}\end{center}
...
\begin{enumerate}
	...
	\item \question{ Supposons que $x = 3$ et $(a,b,c) = (1,-1,2)$. }
	\begin{enumerate}
		...
		\item \question{En déduire $\frac{\partial F}{\partial a}$, $\frac{\partial F}{\partial b}$ en utilisant $\frac{\partial F}{\partial c}$ et les règles ci-dessus. 

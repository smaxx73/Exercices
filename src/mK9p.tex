...
\item
  \question{Mathis pense désormais que le temps moyen de révision est plutôt de $\mu_1 = 4{,}5$ h. En supposant la variance connue et égale à $\sigma^2 = 8$ h$^2$, calculer la puissance du test $H_0 : \mu = 3$ contre $H_1 : \mu > 3$ au niveau $\alpha = 5\%$. Commenter.}
...
\item
  \texte{
    Après l'examen, Emmanuel et Mathis s'interrogent sur la distribution des notes. Ils souhaitent tester l'hypothèse selon laquelle les notes suivent une loi binomiale $\mathcal{B}\!\left(5;\frac{1}{2}\right)$. L'examen est noté sur 5 et 90 étudiants ont composé. Le tableau des effectifs observés est le suivant :
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      Note & 0 & 1 & 2 & 3 & 4 & 5 \\
      \hline
      Effectif observé & 1 & 5 & 31 & 41 & 11 & 1 \\
      \hline
    \end{tabular}
    \end{center}
  }
  \question{À l'aide d'un test du $\chi^2$ d'adéquation au risque $\alpha = 2{,}5\%$, tester l'hypothèse que les notes suivent une loi $\mathcal{B}\!\left(5;\frac{1}{2}\right)$. Justifier soigneusement la démarche.}
  ...
  \reponse{
    ...
    \]
    Les effectifs théoriques $e_k = 90 \times p_k$ sont :
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      \hline
      $e_k$ & $2{,}81$ & $14{,}06$ & $28{,}13$ & $28{,}13$ & $14{,}06$ & $2{,}81$ \\
      \hline
    \end{tabular}
    \end{center}
    ...
    \begin{tabular}{|c|c|c|c|c|}
      ...
      Classe & $\{0,1\}$ & $\{2\}$ & $\{3\}$ & $\{4,5\}$ \\
      \hline
      Effectif observé $o_j$ & 6 & 31 & 41 & 12 \\
      \hline
      Effectif théorique $e_j$ & $16{,}88$ & $28{,}13$ & $28{,}13$ & $16{,}88$ \\
      \hline
    \end{tabular}
    \end{center}
    ...
    \[
      ...
      = \frac{(6-16{,}88)^2}{16{,}88} + \frac{(31-28{,}13)^2}{28{,}13} + \frac{(41-28{,}13)^2}{28{,}13} + \frac{(12-16{,}88)^2}{16{,}88}
      \approx 7{,}01 + 0{,}29 + 5{,}88 + 1{,}41 \approx 14{,}59.
    \]
    ...
    Le quantile $\chi^2_{3;\,0{,}975} \approx 9{,}35$. Comme $D \approx 14{,}59 > 9{,}35$, on rejette $H_0$ au risque $2{,}5\%$ : les données ne sont pas compatibles avec une loi $\mathcal{B}(5;\frac{1}{2})$.
  }

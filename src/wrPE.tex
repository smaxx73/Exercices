...
\contenu{
	...
	\begin{enumerate}
		\item   \question{Après avoir importé les données dans un tableur, calculer la moyenne empirique $\overline{x}$ et l'écart-type empirique $s$ de l'échantillon. Que peut-on remarquer par rapport aux valeurs théoriques en fonctionnement normal ?}
		...
		\item   \question{Construire un intervalle de confiance à 95\% pour la vraie moyenne $\mu$ des temps de réponse. Interpréter ce résultat dans le contexte de la détection d'anomalies.}

...
\begin{enumerate}
	...
	\indication{Déterminer l'ensemble des valeurs prises par $Y$ pour constater que $Y$ est une variable aléatoire discrète. }
	...
	\indication{On peut remarquer que $Y+1$ suit une loi géométrique. }
	\reponse{Pour la variable aléatoire $Y$, on a
		...
		Pour la variable aléatoire $Z$, on procède par linéarité :

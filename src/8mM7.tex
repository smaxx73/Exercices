...
\reponse{ 	Soit $X$ le nombre de fois où le nombre $6$ est apparu sur les $720$ lancers. La variable aléatoire $X$ suit donc la loi $\mathcal{B}(720,\frac{1}{6})$. En particulier, $\E(X)=720\times \frac{1}{6}=120$ et  $\V(X)=720\times \frac{1}{6}\times (1-\frac{1}{6})=100$. }
\begin{enumerate}

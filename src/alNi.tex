...
\texte{Soit $X_1, X_2, \ldots, X_{100}$ une suite de variables aléatoires indépendantes et identiquement distribuées suivant une loi de moyenne $\mu = 30$ et de variance $\sigma^2 = 16$. Soit $S = \sum_{i=1}^{100} X_i$.}

...
\begin{figure}[h!]
	\begin{minipage}{0.32\textwidth}
		...
		\includegraphics[width=1\linewidth]{\exercisespath img/png/aiup-1}
		\caption{N1}
		\label{fig:niveau1}
	...
	\begin{minipage}{0.32\textwidth}
		...
		\includegraphics[width=1\linewidth]{\exercisespath img/png/aiup-2}
		\caption{N2}
		\label{fig:niveau2}
	...
	\begin{minipage}{0.32\textwidth}
		...
		\includegraphics[width=1\linewidth]{\exercisespath img/png/aiup-3}
		\caption{N3}
		\label{fig:niveau3}
...
%\end{enumerate}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.4\linewidth]{\exercisespath img/png/aiup-4}

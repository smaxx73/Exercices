...
\begin{enumerate}
	...
	\reponse{Tout d'abord, on remarque que $f$ est bien définie sur $\R^2$. Elle est continue (et même $C^{\infty}$ sur $\R^2-\{(0,0)\}$ en tant que fraction rationnelle. Pour étudier la continuité en $(0,0)$, on passe en polaires~:
		\begin{align*}

...
Déterminer la loi de $X$, puis calculer son espérance et sa variance.
    ...
    \indication{Poser $p_k=\prob(X=k)$. Traduire les trois informations en égalités entre les $p_k$, puis utiliser $\sum_{k=3}^{6}p_k=1$ ; pour la variance, calculer ensuite $\E(X^2)-\E(X)^2$.}
...
De même,
\[
\E(X^2)=3^2\times \frac{1}{12}+4^2\times \frac{1}{12}+5^2\times \frac{1}{3}+6^2\times \frac{1}{2}=\frac{341}{12}.
\]
Ainsi,
\[
\V(X)=\E(X^2)-\E(X)^2=\frac{341}{12}-\left(\frac{21}{4}\right)^2=\frac{41}{48}.
\]
}
}

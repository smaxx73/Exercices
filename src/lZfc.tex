...
\texte{ Soient $A=\begin{pmatrix}a & 0 & 0 \\ 0 & b & 0 \\ 0 & 0 & c\end{pmatrix}$ et $A=\begin{pmatrix}d & 0 & 0 \\ 0 & e & 0 \\ 0 & 0 & f\end{pmatrix}$.  }
...
\begin{enumerate}
	...
	\item Déterminer $A^k$ pour tout entier $k \geq 1$. 
	...
	\item \`A quelles conditions sur $a,b,c \in \R$ la matrice $A$ est-elle inversible ? Déterminer dans ce cas $A^{-1}$.

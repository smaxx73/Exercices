...
\texte{ Soient $A=\begin{pmatrix}a & 0 & 0 \\ 0 & b & 0 \\ 0 & 0 & c\end{pmatrix}$ et $B=\begin{pmatrix}d & 0 & 0 \\ 0 & e & 0 \\ 0 & 0 & f\end{pmatrix}$.  } \texte{où $a,b,c,d,e,f$ sont des réels quelconques.}

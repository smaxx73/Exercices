...
%	X = arange(0, T + h, h)
%	\end{minted}
	\item \question{ Proposer sur un même graphique la solution approchée de la méthode d'Euler implicite et la solution exacte pour différentes valeurs de $h$. }

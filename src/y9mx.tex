...
\texte{ 	Soit $X$ une variable aléatoire suivant une loi de Bernoulli $\mathcal{B}(p)$ où $p \in ]0;1[$. On considère un $n$-échantillon de $X$ et on note $\overline{X}$ sa moyenne empirique. On pose $Y = n\overline{X}$.  }
	\begin{enumerate}

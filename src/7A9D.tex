...
\begin{enumerate}
	...
	\item \question{Soit \( X \) une variable aléatoire de loi exponentielle \( \mathcal{E}(1) \) de densité \( e^{-x}1_{x \geq 0} \). Montrer que la variable aléatoire \( Z = -\ln(X) \) suit la loi de Gumbel.}
	...
	\item \texte{Soient \( X_1, \ldots, X_n \) des v.a. indépendantes, toutes de loi exponentielle \( \mathcal{E}(1) \). On pose \( M_n = \max(X_1, \ldots, X_n) \) et \( Z_n = M_n - \ln(n) \).}
	
	\question{ Montrer que les variables aléatoires \( M_n \) et \( Z_n \) admettent respectivement les fonctions de répartition :
		\[ F_{M_n}(x) = (1 - e^{-x})^n \mathbf{1}_{x \geq 0}, \quad F_{Z_n}(x) = \left(1 - \frac{e^{-x}}{n}\right)^n \mathbf{1}_{x \geq -\ln(n)}.\]}

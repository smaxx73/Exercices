\uuid{7A9D}
\titre{Exercice sur la distribution de Gumbel et les fonctions de répartition}
...
\contenu{
	\texte{
		...
		\[ G(x) = e^{-e^{-x}}, \quad g(x) = e^{-x}e^{-e^{-x}} = e^{-(x + e^{-x})}. \]
	}
	
\begin{enumerate}
	\item \question{Calculer les limites \( \lim_{x \to -\infty} G(x) \), \( \lim_{x \to +\infty} G(x) \). En déduire que \( g \) est bien une densité de probabilité sur \( \mathbb{R} \). On dira que \( g \), resp. \( G \) sont la densité et la fonction de répartition de la loi de Gumbel.}
	...
	\item \question{Soit \( X \) une v.a. de loi exponentielle \( \mathcal{E}(1) \) de densité \( e^{-x}1_{x \geq 0} \). Montrer que la v.a. \( Z = -\ln(X) \) suit la loi de Gumbel. On pourra chercher à calculer la fonction de répartition de \( Z \).}
	...
	\item \question{Soient \( X_1, \ldots, X_n \) des v.a. indépendantes, toutes de loi exponentielle \( \mathcal{E}(1) \). On pose \( M_n = \max(X_1, \ldots, X_n) \) et \( Z_n = M_n - \ln(n) \). Montrer que les v.a. \( M_n \) et \( Z_n \) suivent respectivement les lois de fonction de répartition
		\[ F_{M_n}(x) = (1 - e^{-x})^n 1_{x \geq 0}, \quad F_{Z_n}(x) = \left(1 - \frac{e^{-x}}{n}\right)^n 1_{x \geq -\ln(n)}.\]}
	...
	\item \question{Calculer la densité \( f_n \) de la loi de \( M_n \) et la densité \( g_n \) de la loi de \( Z_n \).}

...
\begin{enumerate}
	...
	\indication{Étudier l'intégrabilité de $|x|f(x)$ au voisinage de l'infini : son comportement est comparable à une intégrale de type $\int \frac{1}{x}\,\mathrm dx$.}
	...
	\indication{La fonction $\arctan$ est croissante. Pour $t\in]-\pi/2,\pi/2[$, écrire $\{Y\leq t\}=\{X\leq\tan t\}$, puis traiter séparément les deux extrémités du support.}

...
\begin{center}
	\begin{tikzpicture}[x=0.01mm,y=0.01mm] % 3000 -> 54mm = 5.4cm
		\draw[thick,->] (-100,0) -- (3100,0) node[above right] {$x$ (kg)};
...
\end{center}
	...
	\reponse{
		...
		$$
		f(x)=c(x,3000-x)=10000+50x+60(3000-x)-0.05x(3000-x).
		$$
		Calculons :
		$$
		f(x)=10000+50x+180000-60x-0.05(3000x-x^2)=190000-10x-150x+0.05x^2,
		$$
		soit
		$$

...
\contenu{
	...
	\begin{enumerate}
		...
		\indication{Reconnaître $X$ comme une somme de $5000$ Bernoulli indépendantes. Vérifier les conditions usuelles de l'approximation normale, puis expliquer l'effet du centrage et de la réduction.}
		\reponse{ 
		...
		\indication{Si la capacité vaut $c$, imposer $\prob(X\geq c)\leq0{,}025$. Passer à la variable centrée-réduite et utiliser le quantile d'ordre $0{,}975$, puis arrondir la capacité dans le sens de la sécurité.}
		\reponse{ 

...
\begin{enumerate}
	...
	\reponse{ La densité de $X$ se calcule de la manière suivante : pour tout $x \in \R$,
		...
		Enfin, les variables aléatoires $X$ et $Y$ ne sont pas indépendantes car il existe $(x,y) \in \R^2$ tel que $f(x,y)\neq f_X(x)f_Y(y)$. }
	...
	\reponse{ On applique le théorème de transfert au couple $(X,Y)$ :
		\begin{align*}
			...
			&=0.
		\end{align*}
		Pour l'espérance de la variable aléatoire $X$, on a
		\begin{align*}
			\E(X)
			&= \int_\R xf_X(x) \dx \\

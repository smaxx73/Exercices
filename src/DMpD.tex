...
\texte{ Soit la fonction $V \colon \R^2 \to \R$ définie par $$V(r,\theta) = \dfrac{\cos \theta}{r^2}$$ }
	\begin{enumerate}
		...
		\reponse{On a
			\begin{align*}
				\sin \theta \ \dpa{}{r} \left[ r^2 \dpa{V}{r} \right]  + \dpa{}{\theta} \left[ \sin \theta \dpa{V}{\theta} \right] &= \sin\theta \left[ 2r \dpa{V}{r} + r^2 \dpsp{V}{r} \right] + \left[ \cos\theta \dpa{V}{\theta} + \sin\theta \dpsp{V}{\theta} \right] \\
				&= \sin\theta \left[ 2r (-\frac{2}{r^3}\cos\theta) + r^2 \frac{6}{r^4}\cos\theta \right] \\
				&\qquad + \left[ \cos\theta (-\frac{1}{r^2}\sin\theta) + \sin\theta (-\frac{1}{r^2}\cos\theta) \right] \\

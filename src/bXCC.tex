...
%			$$}
	...
	et la suite
	$$
	y_{n+1}=\varphi_2(y_n),\quad y_0\in [0,1].
	$$
	\begin{enumerate}
		...
		\item \question{ En d\'eduire que la suite $(y_n)$ tend vers $\ell$.}
		...
		\item \question{ Ecrire un algorithme qui donne une approximation de $\ell$ à $10^{-6}$ près. Combien faut-il d'itérations pour atteindre cette précision ?}

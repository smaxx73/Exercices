...
\texte{ On sait qu'une personne sur cent est dyslexique. Lors des journées "citoyens", on détecte ce problème. Sur $n$ jeunes examinés, on note $Y_n$ la proportion de dyslexiques. }
	\begin{enumerate}
		...
		\indication{Réécrire l'intervalle comme $|Y_n-0{,}01|\leq0{,}001$, puis utiliser le complément et Bienaymé--Tchebychev avec la variance obtenue à la question précédente.}

...
\indication{ On écrit $x^2-4x = x^2 - 2 \cdot 2x + 2^2 - 2^2 = (x-2)^2 - 4$ et on fait de même pour $y$. }
	...
	\reponse{La ligne de niveau $k$ de $g$ a pour équation $f(x,y) = k$, donc d'après la question 1 
		...
		Il s'agit de l'équation d'un cercle de centre $(2, -3)$ à condition que $k+13 \geq 0$. Sinon c'est l'ensemble vide. Si $k+13 =0$, le cercle est de rayon $0$ est donc réduit à un point (son centre), et si $k+13 >0$ c'est un cercle de rayon $\sqrt{k+13}$ de centre $(2,-3)$.  
	}

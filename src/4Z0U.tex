...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \question{ Donner une approximation de la loi de la variablea léatoire $\bar{X}_{5000}$. } \reponse{ $\bar{X}_{5000} \underset{a p p r o x}{\sim} \mathcal{N}\left(-\frac{2}{37} ; \frac{21 \sqrt{2}}{370}\right)$ }

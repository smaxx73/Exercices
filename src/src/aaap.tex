...
\begin{enumerate}
    \item Soit $\mu$ un réel et $\sigma$ un réel strictement positif. Sans justifier, donner la loi de $X=\sigma Z+\mu$, puis calculer la fonction caractéristique de $ X$.
    ...
    \begin{enumerate}
        \item Calculer la fonction caractéristique de $S$ et en déduire la loi de $S$.
        \item Calculer la valeur de $P(S>450)$ à $10^{-2}$ près.
    \end{enumerate}
\end{enumerate}}
...
Design a neuron that realizes the classification between blue circles and red squares as following. Explain your choices.
...
\reponse{ We want to separate the plane into to half planes. One can consider the red line defined by $y=5x/8+1/2$ that is $5x-8y+4 = 0$ or another line which separates as well, for example $5x-8y=0$.  So this neuron can fit to this problem.

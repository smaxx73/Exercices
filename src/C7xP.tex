...
\theme{Loi normale à moyenne dépendant de la charge, probabilité, quantiles}
...
\contenu{
	...
	\begin{enumerate}
		...
		\indication{Convertir la perte de distance en perte de vitesse grâce à $v=d/t$. Le nombre de tranches de $10$ lb au-delà de $40$ vaut $(W-40)/10$.}
		\reponse{
		...
		\indication{À durée fixée, $D=8V$. Déduire la loi normale de $D$ par transformation affine, puis centrer-réduire chaque seuil.}
		\reponse{
		...
		\indication{Chercher $d$ tel que $\prob(D\geq d)=0{,}95$. Il s'agit donc du quantile inférieur d'ordre $0{,}05$ de la loi de $D=8V$, et non de son quantile d'ordre $0{,}95$.}
		\reponse{
		...
		\indication{Traduire l'objectif en une borne sur $\mu_W$ à l'aide du quantile $z_{0{,}90}$, puis comparer cette borne à la valeur maximale possible de $\mu_W$.}
		\reponse{
		...
		\indication{Procéder comme à la question précédente, puis résoudre l'inégalité obtenue en $W$ dans la formule de $\mu_W$.}
		\reponse{

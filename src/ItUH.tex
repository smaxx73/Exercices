...
De même, on a $$\PP(Z<-a) = \int_{-\infty}^{-a} \frac{1}{\sqrt{2\pi}}\;\; \mathrm{e}^{-\frac{x^2}{2}} dx = -\int_{+\infty}^{a} \frac{1}{\sqrt{2\pi}}\;\; \mathrm{e}^{-\frac{u^2}{2}} du = \int^{+\infty}_{a} \frac{1}{\sqrt{2\pi}}\;\; \mathrm{e}^{-\frac{u^2}{2}} du = \PP(Z>a)$$
  }

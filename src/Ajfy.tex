...
\begin{enumerate}
	...
	\indication{Le nombre de refus suit une binomiale de paramètres $n=100$ et $p$ trouvé à la première question. L'approximation de Poisson a pour paramètre $\lambda=np$.}
	\reponse{ 
	...
	\indication{Utiliser cette fois l'approximation normale de la binomiale, de moyenne $np$ et variance $np(1-p)$. Pour « au moins $50$ », appliquer une correction de continuité au seuil $49{,}5$.}
	\reponse{ 

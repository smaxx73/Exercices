...
\item \question{Vérifier la convergence de la série en comparant le terme général à une série de Riemann.}
\indication{}
\reponse{
Pour $n$ grand, $(2n-1)(2n+1) = 4n^2 - 1 \sim 4n^2$, donc
$$
\frac{1}{(2n-1)(2n+1)} \sim \frac{1}{4n^2}.
$$
La série de Riemann $\displaystyle\sum_{n\geq 1}\frac{1}{n^2}$ converge (exposant $2>1$). Par comparaison par équivalence, la série
$\displaystyle\sum_{n\geq 1}\frac{1}{(2n-1)(2n+1)}$
converge, ce qui est cohérent avec le résultat de la question précédente.
}

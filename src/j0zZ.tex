...
\contenu{
	...
	\texte{
		...
		\begin{itemize}
			\item \(X\) : fraction de cuivre dans l'alliage (entre 0 et 1),
			\item \(Y\) : fraction de zinc dans l'alliage (entre 0 et 1),
		\end{itemize}
	...
	\begin{enumerate}
		...
		\item \question{Déterminer les lois marginales du couple (les loi de $X$ et $Y$ séparément).}
...
\reponse{
	...
	\]
		...
		\item \question{Calculer la loi de la variable aléatoire $X+Y$ qui donne la fraction de cuivre et de zinc réunis.}

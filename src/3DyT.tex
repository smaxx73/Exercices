...
\contenu{
	...
	\indication{Réécrire l'événement comme un écart d'au moins $40$ à la moyenne, puis le majorer par un événement de la forme $\{|X-\E(X)|\geq a\}$ auquel appliquer Bienaymé--Tchebychev.}

...
\begin{enumerate}
	...
	\indication{Appliquer Bienaymé--Tchebychev à $Y_n$, puis majorer $p(1-p)$ par $1/4$.}
	...
	\indication{L'événement recherché équivaut à $|Y_n-p|\leq0{,}01$. Utiliser le complémentaire puis la majoration de la question précédente avec $a=0{,}01$.}
	...
	\indication{Utiliser l'intervalle de confiance de la question précédente : pour conclure que $p>1/2$, sa borne inférieure doit être strictement supérieure à $1/2$.}

...
\contenu{
    ...
    \begin{enumerate}
        ...
        \indication{Le système fonctionne à l'instant $t$ si tous ses composants fonctionnent encore. Traduire cet événement par une intersection, puis utiliser l'indépendance.}
        \reponse{

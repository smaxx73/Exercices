...
\texte{ 	Lors d'une  élection, un  candidat a obtenu 65\% des voix. On considère deux échantillons de 
	votants.  }
\question{Déterminer  la  probabilité  pour  que  deux  échantillons  de  200  votants  chacun 	indiquent  plus  de  10 points  de  différence  entre  les  fréquences  de  gens  qui  ont  voté  pour  ce 	candidat.}

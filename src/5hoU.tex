...
\texte{Soit $D = \{(x,y) \in \R^2 \, , \, x > 0 \, , \, x+y \leq 0\}$ un domaine de $\R^2$.}
\begin{enumerate}
	\item \question{Proposer une représentation graphique de $D$.}
		...
		\item \question{$D$ est-il ouvert dans $\R^2$ ? justifier rapidement.}
		...
		\item \question{Vérifier que le point $(0,-1)$ n'appartient pas à $D$. Déterminer une suite de points $(x_n,y_n) \in D$ tels que $(x_n,y_n) \xrightarrow[n \to +\infty]{} (0,-1)$.}
		\reponse{ On a  $(0,-1) \notin D$ par définition de $D$, en revanche on peut définir la suite $(x_k,y_k) = (1/k,-1) \in D$ qui converge vers $(0,-1)$. }
		\item \question{$D$ est-il fermé dans $\R^2$ ? justifier rapidement.}

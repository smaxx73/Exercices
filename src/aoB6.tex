...
\begin{enumerate}
    \item \question{ $S_1(t)=\sum_{n= 0}^{+\infty} n^2 t^n$ }
    ...
    \item \question{ $S_2(t)=\sum_{n=0}^{+\infty} \frac{(-2)^n}{n!}t^n$ } 
    ...
    \item \question{ $S_3(t)=\sum_{n=1}^{+\infty} \sin\left( \frac{1}{n^2}\right) t^n$ }
    ...
    \item \question{ $S_4(t)=\sum_{n=1}^{+\infty} \frac{\ln n}{n} t^n$ }
	...
	\item \question{ $S_5(t)=\sum_{n=1}^{+\infty} \frac{1}{n^n}t^n$ }
    ...
    \item \question{ $S_6(t)=\sum_{n=2}^{+\infty} \frac{n^n}{\ln n} t^n$ }
    ...
    \item \question{ $S_7(t)=\sum_{n=0}^{+\infty} 2^n t^{2n}$ }
    ...
    \item \question{ $S_8(t)=\sum_{n=1}^{+\infty} \frac{(1+i)^n}{n2^n}t^{3n}$ } 

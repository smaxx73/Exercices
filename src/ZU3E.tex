...
\contenu{
    ...
    \begin{enumerate}
        ...
        \indication{Exprimer le complémentaire de l'événement demandé comme un écart à la moyenne, en tenant compte du fait que $X$ est à valeurs entières, puis appliquer Bienaymé--Tchebychev.}
        \reponse{
        ...
        \indication{La somme a moyenne et variance égales à $16$. Approcher par une normale de ces paramètres et, pour une approximation plus précise, appliquer la correction de continuité aux bornes entières.}
        \reponse{

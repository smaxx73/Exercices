...
\contenu{
	\texte{
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|}
				\hline
				Tireur & Distance (cm) & Tireur & Distance (cm) & Tireur \\
				\hline
				1 & 5.2 & 11 & 9.8 & 21 \\
				2 & 12.3 & 12 & 4.1 & 22 \\
				3 & 8.7 & 13 & 11.2 & 23 \\
		...
		\textbf{Données complémentaires :} Après calculs préliminaires sur tableur, 
		on obtient : $\bar{x} = 9.23$ cm et $s^2 = 11.67$ cm$^2$.
	...
	\begin{enumerate}
		...
		\reponse{
			...
			4.1, 4.9, 5.2, 5.7, 6.5, 6.9, 7.4, 7.8, 8.3, 8.7, 9.2, 9.8, 10.5, 
			11.2, 11.8, 12.3, 13.5, 13.6, 14.2, 15.1
			
			\begin{itemize}
				\item Minimum : 4.1 cm
				\item Q1 (25\%) : 6.7 cm
				\item Médiane (50\%) : 9.0 cm
				\item Q3 (75\%) : 12.0 cm
				\item Maximum : 15.1 cm
				\item Écart interquartile : IQR = 5.3 cm
			\end{itemize}
			...
			$$[6.7 - 1.5 \times 5.3; 12.0 + 1.5 \times 5.3] = [-1.25; 19.95]$$
			
			Toutes les valeurs sont dans cet intervalle : \textbf{pas de valeur aberrante}.
			
			\textbf{Cohérence avec la normalité :}
			\begin{itemize}
				\item La distribution semble relativement symétrique autour de la médiane
				\item L'écart-type $s \approx 3.42$ cm est raisonnable
				\item Pas de valeurs extrêmes
		...
		\indication{
			Avec un tableur :
			\begin{itemize}
				\item Histogramme : sélectionner les données, Insertion $\to$ Graphique $\to$ Histogramme
				\item Boîte à moustaches : Insertion $\to$ Graphique $\to$ Boîte à moustaches
				\item Quartiles : \texttt{=QUARTILE.INCLURE(plage; k)} avec k=0,1,2,3,4
			\end{itemize}
		}
		...
		\reponse{
			...
			\textbf{Analogie militaire :} Une section qui tire groupé mais systématiquement 
			à côté de l'objectif est comme une batterie d'artillerie bien réglée en portée 
			mais avec une déviation constante en azimut : le problème est corrigible 
			par un ajustement technique.
		}
		...
		\item \textbf{[Bonus - Analyse avancée]} \question{

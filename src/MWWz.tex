...
\contenu{
	...
	La fonction caractéristique d'une variable aléatoire $X_i$ suivant une loi uniforme sur $[-d;d]$ est donnée par : $$\phi_{X_i}(t) = \mathbb{E}[e^{itX_i}] = \frac{1}{2d} \int_{-d}^{d} e^{itx} \, dx = \frac{\sin(dt)}{dt}.$$

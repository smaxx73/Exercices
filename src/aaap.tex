...
\begin{enumerate}
    ...
    \item \texte{ Soit $(X_1,\dots{},X_5)$ une suite de 5 variables aléatoires indépendantes et équidistribuées selon une loi normale de moyenne $\mu=70$ et d’écart type $\sigma=15$. Soit $S=\displaystyle\sum_{i=1}^{5}X_i$. }
    \begin{enumerate}
        \item \question{ Calculer la fonction caractéristique de $S$ et en déduire la loi de $S$. }
        \item \question{ Calculer la valeur de $\prob(S>450)$ à $10^{-2}$ près. }
    \end{enumerate}
\end{enumerate}}
...
\contenu{
	...
	\texte{A chaque fonction définie ci-dessous (1-6), associer ses courbes de niveaux (A-F).
	\begin{enumerate}
	...
	\begin{minipage}{0.5\textwidth}
		\includegraphics[]{\exercisespath img/pdf/r0au-tikz-1}
	\end{minipage}
	\hfill
	\begin{minipage}{0.5\textwidth}
		\includegraphics[]{\exercisespath img/pdf/r0au-tikz-2}
	\end{minipage}
	
	\begin{minipage}{0.5\textwidth}
		\includegraphics[]{\exercisespath img/pdf/r0au-tikz-3}
	\end{minipage}
	\hfill
	\begin{minipage}{0.5\textwidth}
		\includegraphics[]{\exercisespath img/pdf/r0au-tikz-4}
	\end{minipage}
	
	\begin{minipage}{0.5\textwidth}
		\includegraphics[]{\exercisespath img/pdf/r0au-tikz-5}
	\end{minipage}
	\hfill
	\begin{minipage}{0.5\textwidth}
		\includegraphics[]{\exercisespath img/pdf/r0au-tikz-6}
	\end{minipage}

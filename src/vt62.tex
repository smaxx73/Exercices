...
\begin{enumerate}
	\item \question{ Si $A$ est inversible, alors $A .\left(A^\top\right)=\left(A^\top\right) \cdot A$.  }
	...
	\item \question{ Si $A$ est inversible, alors $A .\left(A^\top\right)$ est inversible ; }

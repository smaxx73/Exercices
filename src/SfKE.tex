...
\begin{enumerate}
	\item \question{ Calculer le rayon de convergence $R$ de cette série entière. Que peut-on dire de la série $\displaystyle \sum_{n \geq 0} \frac{(n+1)x^n}{2^n}$ si $|x|>R$ ? si si $|x|<R$ ? si $x=R$ ? si $x=-R$ ? }
	\reponse{On pose $u_n(x) = \frac{(n+1)x^n}{2^n}$ et on utilise le théorème de d'Alembert : 
		...
		\end{align*}
		Donc la série converge absolument si et seulement si $\frac{1}{2}|x|<1 \iff |x|<2$, cela revient à dire que le rayon de convergence est $R=2$. D'après le cours, la série diverge grossièrement si $|x|>2$.
	...
	\item \question{ Donner la somme de la série $\displaystyle \sum_{n \geq 0} \left( \frac{x}{2} \right)^n$ lorsque $x\in I$ où $I$ est l'intervalle de convergence de cette série. En déduire la somme de la série       $\displaystyle \sum_{n \geq 0} \frac{(n+1)x^n}{2^n}$. }
	\reponse{On reconnaît une série géométrique qui converge si $\frac{|x|}{2}<1$ d'où un rayon de convergence $R=2$. La somme vaut 
		...
		Par dérivation d'une série entière sur son intervalle ouvert de convergence, on obtient pour tout $x \in ]-2;2[$ : 

...
\begin{enumerate}
	...
	\item \question{ Soit la série $\displaystyle \sum_{n \geq 0} \left( \frac{x}{2} \right)^n$ et $R'$ sont rayon de convergence. Calculer $R'$ puis calculer la somme de cette série pour tout $x\in ]-R',R'[$.  }

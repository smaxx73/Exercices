...
\contenu{
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\indication{Pour l'approximation normale d'une Poisson, conserver la même moyenne et la même variance, toutes deux égales à $\lambda$.}
			\reponse{ 
			...
			\indication{Centrer-réduire les deux bornes avec la moyenne et l'écart-type de $Y$. L'intervalle de largeur $1$ autour de $15$ est la correction de continuité associée à la valeur entière $15$.}
			\reponse{ 
				\begin{align*}
		...
		\indication{Remplacer l'intervalle entier $[15,20]$ par $[14{,}5,20{,}5]$ pour la variable normale approchante, puis centrer-réduire les deux bornes.}
		\reponse{ 
			\begin{align*}

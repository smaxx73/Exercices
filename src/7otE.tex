...
\begin{enumerate}
	...
	\reponse{ La taille de la population n'influence pas le résultat de l'estimation. Mais plus la taille de l'échantillon est importante, plus le sondage est précis. Il vaut donc mieux faire un sondage sur 2000 personnes que sur 1000 personnes. }

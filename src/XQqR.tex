...
\texte{ La méthode d'Euler explicite est convergente et consistante d'ordre 1. 

On décide d'approcher $\int_{t_n}^{t_{n+1}}f(s,y(s))ds \approx h\cdot f\left( t_n+\frac{h}{2},y\left( t_n+\frac{h}{2} \right)  \right)$.

...
$
\sum_{n\geq 1}\ln\left(1+\frac1n\right)
$
converge.}
\indication{}
\reponse{
...
$
\sum_{n=1}^N \ln\left(1+\frac1n\right)=\ln(N+1),
$
...
\item   \question{Si $u_n\sim v_n$ avec $u_n\ge 0$, $v_n\ge 0$ à partir d’un certain rang et que la série $\sum u_n$ diverge alors la série $\sum v_n$ diverge.}
\indication{}
\reponse{
...
\item   \question{La série
$
\sum_{n\geq 2}\left(\frac{2}{3}\right)^n
$
a pour somme $\dfrac{4}{3}$.}
\indication{}
\reponse{

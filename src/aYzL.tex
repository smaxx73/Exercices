...
\begin{enumerate}
	...
	\item \question{ Compléter le code Python suivant, comportant deux champs manquants, afin qu'il affiche une approximation de $I$.
}		
\begin{verbatim}
n=1000
S=0
...
\end{verbatim} 
	...
	\reponse{ Il manque \texttt{u=rand()} et \texttt{print(S/n)} }

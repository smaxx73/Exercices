...
\contenu{
	...
	\begin{enumerate}
		...
		\indication{Partir de $F_Y(t)=\prob(Y\leq t)$ et résoudre l'inégalité définissant $Y$ en fonction de $X$. Bien distinguer les valeurs de $t$ situées hors du support de $Y$.}
		...
		\indication{Remplacer dans l'expression précédente la fonction de répartition de la loi uniforme ; comparer alors la fonction obtenue à celle d'une loi exponentielle.}
		\reponse{ 

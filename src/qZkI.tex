...
\difficulte{3}
\contenu{
	\texte{ On considère deux avions $A$ et $B$ ayant respectivement 4 et 2 moteurs. Les moteurs fonctionnent de manière indépendante et chacun a une probabilité $p \in ]0;1[$ de tomber en panne. On admet qu'un vol se termine bien si au plus la moitié des moteurs tombe en panne.
	}

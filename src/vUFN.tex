...
\texte{Soit $(\Omega, \mathcal{A}, \prob)$ un espace probabilisé. On considère deux variables aléatoires discrètes $X$ et $Y$ telles que $X(\Omega) = \{1,2,3\}$, $Y(\Omega) = \{1,2,3,4\}$ et $\prob(X = x, Y = y)$ et : 

...
\begin{enumerate}
	...
	\indication{Écrire $\prob(T>15\mid T>10)$ : comme $\{T>15\}\subset\{T>10\}$, le quotient se simplifie. Vous retrouvez l'absence de mémoire de la loi exponentielle.}
	\reponse{
		\begin{align*}
	...
	\indication{Chaque caisse fournit une épreuve de Bernoulli de succès « attente supérieure à 10 minutes », de probabilité $e^{-0{,}12\times10}$. Identifier la loi binomiale puis sommer les trois probabilités correspondant à $4$, $5$ et $6$ succès.}
	\reponse{ 

...
\contenu{
    ...
    \indication{Pour comparer les probabilités a posteriori, les trois dénominateurs sont les mêmes : il suffit donc de comparer les produits $\prob(p_i)\prob(s\mid p_i)$.}

...
\contenu{
	...
	\begin{enumerate}
		...
		\reponse{ On s'intéresse à la convergence de la série $ \sum |\frac{(-1)^n}{n} +\frac{1}{n^2} |$. On a:
			\[ \Big|\frac{(-1)^n}{n} +\frac{1}{n^2}\Big| \leq \frac{1}{n} + \frac{1}{n^2} \sim \frac{1}{n}.\]
			Or $\sum \frac{1}{n}$ est une série de Riemann divergente. Donc par le théorème d'équivalence, la série $ \sum |\frac{(-1)^n}{n} +\frac{1}{n^2} |$ n'est pas convergente. On en déduit que la série $ \sum \frac{(-1)^n}{n} +\frac{1}{n^2}$ n'est pas absolument convergente.}
\end{enumerate}
}

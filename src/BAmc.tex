...
\texte{ 	On pose $f: \R^2 \to \R$ définie pour tout $(x,y) \in \R^2$ par : $$f(x,y) = \dfrac{x^2+xy}{y^2}.$$ }
\begin{enumerate}
	...
	\item \question{ On note $F: \R \to \R$ la fonction définie pour tout $t\in \R$ par $F(t) \mapsto t^2+t$. 
		
		En remarquant que $f(x,y) = F\left(\dfrac{x}{y}\right)$, et en utilisant les règles de dérivation composée, retrouver les expressions obtenues à la question~\ref{Q1}. }

...
\begin{enumerate}
	...
	\reponse{ Pour tout $x\in\R$,
		...
		Comme les variables aléatoires $X_i$ sont i.i.d., on obtient:
		...
		\end{cases}
		$.
		La variable aléatoire $Y_A$ est donc absolument continue et sa densité vaut $f_{Y_A}(t)=F'_{Y_A}(t)=3t^2\textbf{1}_{[0;1]}(t)$.}
	...
	\reponse{Comparons l'espérance des variables aléatoires $Y_A$ et $Y_B$:
		\begin{align*}

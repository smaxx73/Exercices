...
\contenu{
En France, la moyenne de consommation électrique annuelle individuelle est de 1100 kWh. On s'intéresse à la consommation de certains quartiers de la ville de Nouille-Orque.
...
\begin{enumerate}
	...
	\item Calculer la puissance de ce test pour une hypothèse alternative $H_1 \colon \mu = 1600$.
\end{enumerate}

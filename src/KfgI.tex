...
%	\item \question{ Montrer que les quatre méthodes de point fixe sont consistantes avec la recherche du zéro de $f$, \textit{i.e.} montrer que pour tout $x\in]\frac{1}{5};\frac{1}{2}[$, on a : $ \phi_i(x)=x  \Leftrightarrow  f(x)=0 \qquad \text{ pour } i=1,2,3,4.$ }
...
%					\addplot [dotted,thick,blue] coordinates { (-0.5,0) (-0.5,\newtfonc{-0.5}) (\newtfonc{-0.5},\newtfonc{-0.5}) (\newtfonc{-0.5},0) };
%					\addplot [dotted,thick,blue] coordinates { (0.61,\newtfonc{0.61}) (\newtfonc{0.61},\newtfonc{0.61}) };
%					\addplot [dotted,thick,blue] coordinates {(\newtfonc{0.61},0) (\newtfonc{0.61},0.30)};
%				\end{axis}
%			\end{tikzpicture}
%		\end{center}

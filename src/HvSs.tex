...
\texte{Une machine est conçue pour fabriquer des pièces pesant chacune $0{,}5$~g. Dans les faits, le résultat n'est pas parfait et on observe que la distribution du poids de chaque pièce a une moyenne de $0{,}50$~g et un écart type de $0{,}02$~g.}

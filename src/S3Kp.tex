...
\begin{enumerate}
	\item \question{ Soit $\overline{X}$ la variable aléatoire égale au poids moyen d'une pièce dans un échantillon de $n$ pièces. Que peut-on dire de la loi de $\overline{X}$ ? }
	...
	\item \question{ On considère deux échantillons de 1000 pièces chacun. Déterminer la probabilité que le poids de deux lots de 1000 pièces chacun diffèrent entre eux de plus de 2 grammes.  }

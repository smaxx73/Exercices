...
\begin{enumerate}
	...
	\indication{Appliquer Bienaymé--Tchebychev avec la moyenne et la variance d'une loi de Poisson. Puis remarquer que $\{X\geq2\lambda\}$ est inclus dans l'événement d'écart à la moyenne considéré.}
	...
	\indication{Comparer directement les deux majorants $1/2$ et $1/\lambda$ ; la plus petite borne est la plus informative.}

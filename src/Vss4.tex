...
\begin{enumerate}
    ...
    \reponse{
        La variable aléatoire $X$ suit une loi binomiale de paramètres $n = 1000$ et $p = 0{,}05$, ce qui se note $X \hookrightarrow \mathcal{B}(1000, 0{,}05)$. On a $\mathbb{E}(X) = n \times p = 1000 \times 0{,}05 = 50$ et $\sigma(X) = \sqrt{n \times p \times (1-p)} = \sqrt{1000 \times 0{,}05 \times 0{,}95} = 7{,}5$.
    }
    ...
    \reponse{
        ...
        Donc, pour $k = 50$, on a :
        \[
        \prob(|X - 50| > 50) \leq \frac{7{,}5^2}{50^2} = \frac{56{,}25}{2500} = 0{,}0225.
        \]
        Donc, $\prob(X > 100) = \prob(X - 50 > 50) \leq \prob(|X - 50| > 50) \leq 0{,}0225$.
    }
    ...
    \reponse{
        ...
        Or $X$ suit la même loi que $S_{1000}$ donc $X$ peut être approchée par une variable suivant une loi normale de moyenne $\mu = 50$ et d’écart-type $\sigma = 7{,}5$. 
    }
    ...
    \reponse{
        On calcule : 
        \begin{align*}
            \prob\left( 48 \leq X \leq 52 \right) & = \prob\left( \frac{48 - 50}{7{,}5} \leq \frac{X - 50}{7{,}5} \leq \frac{52 - 50}{7{,}5} \right) \\
            & = \prob\left( -\frac{2}{7{,}5} \leq \frac{X - 50}{7{,}5} \leq \frac{2}{7{,}5} \right) \\
            & = \prob\left( -\frac{2}{7{,}5} \leq Z \leq \frac{2}{7{,}5} \right) \\
            &= 2 \times \prob\left( Z \leq \frac{2}{7{,}5} \right) - 1 \\
            & = 2 \times \Phi\left( \frac{2}{7{,}5} \right) - 1 \\
            & \approx 2 \times 0{,}76026 - 1 \\
            & \approx 0{,}5252.
        \end{align*}
    }
\end{enumerate}

...
\begin{enumerate}
	...
	\indication{Noter $A$ l'événement « pièce de un euro » et $F$ l'événement « fausse ». Appliquer Bayes en réutilisant la probabilité totale $\prob(F)$ obtenue à la question précédente.}
	\reponse{ 
		On calcule :
...
En approchant cette loi par celle d'une loi normale adaptée, donner une approximation de la probabilité pour que $X$ soit compris entre $48$ et $52$. }
	\indication{Modéliser chaque pièce par une Bernoulli de paramètre $0{,}05$. Pour l'approximation normale, employer la correction de continuité : l'intervalle entier $[48,52]$ devient $[47{,}5,52{,}5]$.}
	\reponse{ 
		On a: $X\sim \mathcal{B}(\nombre{1000},0.05)$, $\E(X)=\nombre{1000}\times 0.05=50$ et $\sigma^2(X)=\nombre{1000}\times 0.05\times 0.95=47.5$. \\
		La variable aléatoire $X$ peut être approchée (avec correction de continuité) par la variable aléatoire $Y$ de loi $\mathcal{N}(50,\sigma^2=47.5)$. Ainsi, on a
		\begin{align*}

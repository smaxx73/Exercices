...
\reponse{ Soit $X$ l'heure d'arrivée du général Contant et $Y$ l'heure d'arrivée du général Janty. L'énoncé suggère que $X$ et $Y$ sont des variables aléatoires indépendantes et nous dit qu'elles suivent toutes les deux une loi uniforme sur $[20;21]$.

...
\begin{enumerate}
	...
	\indication{On ne demande pas ici que $X$ soit une variable aléatoire à densité. Il faut donc trouver des conditions pour que les limites en $+\infty$ et $-\infty$ de $F$ soient correctes, que $F$ soit croissante sur $\R$ et continue à droite. }
	...
	\indication{Il faut ajouter une condition supplémentaire : $F$ doit être continue en tout point de $\R$ et pas seulement continue à droite. }
\end{enumerate}

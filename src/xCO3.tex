...
\texte{ On pose $f(x,y)=k(1+xy(x^2-y^2)) \textbf{1}_{[-1;1]^2}(x,y)$. }
...
\begin{enumerate}
	...
	\item \question{ Déterminer les densités marginales de $X$ et de $Y$, ainsi que leurs fonctions caractéristiques. Les variables $X$ et $Y$ sont-elles indépendantes ? }

...
\begin{enumerate}
	...
	\reponse{On ne peut pas utiliser des formules de dérivation puisqu'il n'y a pas d'expression de la fonction au voisinage de ce point. On doit donc revenir à la définition et regarder la limite du taux d'accroissement pour chaque variable.
		\begin{align*}

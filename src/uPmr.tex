...
\begin{enumerate}
	...
	\indication{Centrer et réduire la variable, puis utiliser une lecture inverse de la table de la fonction de répartition d'une loi normale centrée réduite. }

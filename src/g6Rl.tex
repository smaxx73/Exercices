...
\chapitre{Théorème central limite}
\sousChapitre{Approximation normale}
\theme{probabilités}
...
\contenu{
	...
	\begin{enumerate}
		...
		\reponse{Si les $X_i$ suivent des lois Normales, alors $X_i\sim \mathcal{N}(0.6,\sigma=0.1)$ et la variable $\displaystyle X=\sum_{i=1}^{36} X_i$ suit une loi Normale de paramètres $\mu=36\times 0.6=21.6$ et $\sigma=\sqrt{36\times 0.1^2}=0.6$.}

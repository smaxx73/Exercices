...
\begin{enumerate}
	...
	\item \question{ Décomposer la fraction rationnelle $\displaystyle \frac{1}{n^2+3n+2}$ en éléments simples, c'est-à-dire trouver les réels $\alpha$ et $\beta$ tels que:
	\[ \frac{1}{n^2+3n+2}=\frac{\alpha}{n+1}+\frac{\beta}{n+2}.\] }
	\reponse{ 
		$\alpha=1$ et $\beta=-1$
	}

...
\item  
\question{ Pour $u \in \mathbb{R}^2$, on désigne par $D_u f(x_0;y_0)$ la dérivée directionnelle de $f$ dans la direction du vecteur $u$. 

On rappelle que $$D_u f(x_0;y_0) = \nabla f(x_0;y_0)\cdot u $$

Que pouvez-vous alors dire du gradient de $f$ (ici noté $\nabla f$ en $(x_0;y_0)$ par rapport au vecteur $u$ si celui-ci est tangent à $\Gamma$ en $(x_0;y_0)$ ? 
}
...
\reponse{
Calculons les gradients des deux fonctions:
...
Si ces vecteurs sont colinéaires, alors nous avons: 

$$ \det \begin{vmatrix}
2x_0 & 4x_0^3 \\ 2y_0 & 4y_0^3\end{vmatrix} = 0$$ 

Nous obtenons donc le système suivant (en ajoutant la contrainte $\Gamma$): 

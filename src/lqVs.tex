...
\begin{enumerate}
	...
	\item \question{ Montrer que la m\'ethode de Gauss-Seidel converge pour ce probl\`eme. }
	\reponse{Pour utiliser la méthode de Gauss-Seidel, il faut s'assurer que la matrice $A$ est symétrique définie positive. Elle est visiblement symétrique réelle donc diagonalisable. Il reste donc à vérifier que ses valeurs propres sont toutes strictement positives. 

...
\begin{enumerate}
	...
	\item \question{ Déterminer la courbe de niveau $k=1$ de la fonction $f$. }
	\indication{ Vérifier que la courbe de niveau $k=1$ est un cercle de centre $\left(\frac{1}{2} ; -1 \right)$ dont on déterminera le rayon.}
	...
	\indication{Il faut revenir à la définition en calculant la limite du taux d'accroissement pour chaque variable en $(0,0)$. }
	\reponse{

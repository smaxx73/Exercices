...
On considère que le temps de contrôle d'une entreprise est une variable aléatoire de loi $\mathcal{N}\left(m, \sigma\right)$. On réalise 7 contrôles et on obtient les temps suivants (en jours) :
$$
\begin{array}{lllllll}
...
\begin{enumerate}
	\item 
\question{ Donner une estimation de $m$ et de la variance $\sigma^2$. On précisera les estimateurs utilisés en indiquant leurs propriétés.}

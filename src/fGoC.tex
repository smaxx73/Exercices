...
\begin{enumerate}
    ...
    \item \question{ En déduire un estimateur sans biais de $b$ sous la forme $\alpha Y_n$ où $\alpha$ est un réel à déterminer. }
    \item \question{ Déterminer la fonction de répartition de $Z_n$. }
    \item \question{ En déduire que $Z_n$ suit une loi de Pareto de paramètres $(n, b)$. }
    \item \question{ En déduire un estimateur sans biais de $b$ sous la forme $\beta Z_n$ où $\beta$ est un réel à déterminer. }

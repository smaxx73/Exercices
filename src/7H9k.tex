...
\contenu{
	...
	\begin{enumerate}
		...
		\item \question{Soit $(X_1,...,X_n)$ un échantillon de taille $n\in\N^*$ de $X$. On pose pour tout $k\in \left[\left|1,n\right|\right]$, $Y_k=-\ln(X_k)$. On pose aussi $S_n=\sum_{k=1}^n Y_k$. Montrer que $\frac{S_n}{n}$ est un estimateur sans biais de $\frac{1}{\theta}$.}
		...
		\reponse{L'estimateur $\frac{S_n}{n}$ étant sans biais, il suffit de vérifier que la variance tend vers 0.
			...
			\]}
		\item \question{Montrer que $\frac{n}{S_n}\stackrel{p.s.}{\rightarrow}\theta$.}

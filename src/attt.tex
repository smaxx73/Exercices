...
\reponse{$-1$ est une racine réelle de $X^3+1$ et $X^3+1=(X-1)(X^2+X+1)$. Ainsi $j=\exp(2i\pi/3)$ et $\bar{j}$ sont les racines complexes de $X^2+X+1$ donc de $X^3+1$.}
...
$$R(X)=(X-1)(X-j)(X-\bar{j})\prod_{k=0}^{5}(X-z_k).$$}
\end{enumerate}
}
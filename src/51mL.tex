...
\contenu{
    ...
    \begin{enumerate}
        ...
        \indication{Vérifier que $f(x) \geq 0$ pour tout $x$ réel et calculer $\int_{-\infty}^{+\infty} f(x) \mathrm{d}x$.}
        \reponse{
            \begin{enumerate}
        ...
        \indication{Prendre l'indicatrice de l'ensemble sur lequel la fonction $f$ n'est pas nulle et multiplier par la valeur souhaitée (ici $2x$). }
        \reponse{

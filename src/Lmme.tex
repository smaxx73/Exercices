...
\contenu{
	...
	\begin{enumerate}
		...
		\indication{ Exprimer la dérivée partielle $\frac{\partial r}{\partial x_i}$ puis utiliser ensuite la règle de composition pour calculer $\frac{\partial f}{\partial x_i}$, puis dérive une seconde fois pour obtenir $\frac{\partial^2 f}{\partial x_i^2}$. Lors de la sommation, se souvenir que $\sum\limits_{i=1}^n x_i^2 = r^2$. }
		...
		\indication{ L'équation $\Delta f = 0$ donne une équation différentielle d'ordre 2 pour la fonction $g$. Pour la résoudre, poser $y(r) = g'(r)$ afin de se ramener à une équation différentielle linéaire du premier ordre. Attention, lors de l'intégration finale pour trouver $g$, il faudra distinguer les cas $n=2$ et $n \geq 3$. }

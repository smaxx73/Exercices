...
\contenu{
    ...
    \begin{tcolorbox}        Pour $T_1,T_2$ deux variables al\'eatoires absolument continues telles que pour tout $t\geq 0$ on ait: $\mathcal{L}_t(T_1)=\mathcal{L}_t(T_2).$ Alors les variables $T_1$ et $T_2$ suivent la m\^eme loi. 
    \end{tcolorbox}

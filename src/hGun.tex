...
\item D\'eterminer $\mathcal{L}_{t}(Z_1)$ et en déduire $\mathcal{L}_t(S_n)$ pour tout $t\geq 0$. 
\reponse{
...
\item Soit $U$ une variable aléatoire absolument continue de densit\'e de probabilit\'e $f_U$. Calculer, pour tout $t\geq 0,$ $\mathcal{L}_t(U)$. Conclure.
\reponse{
    On a 
    \begin{align*}
